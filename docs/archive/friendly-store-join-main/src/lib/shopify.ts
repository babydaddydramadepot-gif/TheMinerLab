...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "i1ikrb-f0.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "0c3c0991d0898f25e2666e5c11b0e9ca";
...
export async function fetchCartTotal(cartId: string) {
  return await storefrontApiRequest(CART_QUERY, { id: cartId });
}
